<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Thank you for choosing Job Starter. Use the following OTP to complete your Sign Up procedures. OTP is valid for 60 minutes</p>
    <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff; border-radius: 4px; ">{{ $details['code'] }}</h2>
    <p style="font-size:0.9em;">Regards,<br />Job Starter</p>
