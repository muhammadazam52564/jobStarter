    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="row bg-white mt-4 shadow p-3 mb-5 bg-white rounded">
                ...
                <div class="col-md-12 ">
                    <form class="form-group pt-3" method="POST" action="{{ route('admin.add-category') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="w-100">
                        ...
                        <div class="w-100 d-flex py-2">
                            ...
                            <div class="w-50 pl-2 d-flex pt-2 justify-content-center">
                                <img src="" style="max-width: 160px"  class="d-none" id="image_preview"/>
                            </div>
                        </div>
